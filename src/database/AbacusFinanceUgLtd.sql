...
ALTER TABLE loan_applications ADD COLUMN loan_date VARCHAR(50) NOT NULL DEFAULT 'null'; -- To be run against production database
ALTER TABLE loan_applications ADD COLUMN is_approved BOOLEAN NOT NULL DEFAULT false; -- To be run against production database
ALTER TABLE sacco_membership ADD COLUMN sacco_date VARCHAR(50) NOT NULL DEFAULT 'null'; -- To be run against production database
ALTER TABLE sacco_membership ADD COLUMN is_approved BOOLEAN NOT NULL DEFAULT false; -- To be run against production database
